    ...
    <div class="container">
            ...
            <section>
                <?php if(!empty($mys)): if(is_array($mys)): foreach($mys as $key=>$row): ?><figure class="jia">
                            <div class="row">
                                <div class="col-xs-4">
                                <img src="__PUBLIC__/Uploads/theimg/<?php echo ($row['img']); ?>" class="thelogo">
                                </div>
                                <div class="col-xs-6">
                                <figcaption>
                                    <a href="__APP__/Theme/theartall/id/<?php echo ($row['id']); ?>"><?php echo ($row['name']); ?></a>
                                    <?php if($row['count'] == 1): ?><button class="subed conbtn" vid="<?php echo ($row['id']); ?>">已订阅</button>
                                        <?php else: ?>
                                        <button class="nosub conbtn" vid="<?php echo ($row['id']); ?>">+订阅</button><?php endif; ?>
                                </figcaption>
                                </div>
                            </div>
