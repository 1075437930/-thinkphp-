...
<table class="table table table-striped table-bordered table-hover table-condensed">
    ...
    <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
            ...
            <td>
                <img src="__PUBLIC__/Uploads/theimg/<?php echo ($row['img']); ?>" width="50px">
            </td>
            <td>
                <?php echo ($row['cn']); ?>
            </td>
            ...
            <td>
                <a href="__URL__/edit/id/<?php echo ($row['id']); ?>/name/<?php echo ($row['name']); ?>/class/<?php echo ($row['class_id']); ?>"><span class="glyphicon glyphicon-wrench"></span></a>
            </td>
            <td>
                <a href="__URL__/delete/id/<?php echo ($row['id']); ?>"><span class="glyphicon glyphicon-remove-sign"></span></a>
            </td>
