    ...
    <div class="form-group">
        ...
        <select name="theme" class="form-control">
            ...
            <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><option value="" disabled><?php echo ($row['name']); ?></option>
                <?php if(is_array($row['the'])): foreach($row['the'] as $key=>$row2): ?><option value="<?php echo ($row2['id']); ?>" style="color: red">|_ _ _<?php echo ($row2['name']); ?></option><?php endforeach; endif; endforeach; endif; ?>
        </select>
    </div>
    <div class="form-group">
        ...
        <select name="site" class="form-control">
            ...
            <?php if(is_array($rows3)): foreach($rows3 as $key=>$row): ?><option value="" disabled><?php echo ($row['name']); ?></option>
