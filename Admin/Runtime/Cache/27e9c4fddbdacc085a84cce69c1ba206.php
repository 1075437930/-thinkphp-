...
<head>
    ...
    <script>
        $(function(){
            $('.passcode').attr('src',"/kt/admin.php/Login/verify/"+Math.random());
        })
    </script>
</head>
<body>
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img src="__URL__/verify" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">
