        ...
        <div class="panel-body">
            <table class="table table table-striped table-bordered table-hover table-condensed">
                ...
                <?php if(is_array($row['art'])): foreach($row['art'] as $key=>$row2): ?><tr>
                        ...
                        <td class="nei"><?php echo htmlspecialchars_decode($row2['content']);?></td>
                        <td><?php echo date('Y-m-d',$row2['time']);?></td>
                        <td><?php echo ($row2['fabnum']); ?></td>
                        <td class="a1"><a href="__URL__/aredit/id/<?php echo ($row2['id']); ?>"><span class="glyphicon glyphicon-wrench"></span></a> </td>
                        <td class="a1"><a href="__URL__/ardelete/id/<?php echo ($row2['id']); ?>"><span class="glyphicon glyphicon-remove-sign"></span></a></td>
