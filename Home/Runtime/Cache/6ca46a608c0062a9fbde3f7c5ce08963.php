...
<head>
    ...
    <link href="../Public/Css/mycourse.css" rel="stylesheet">
    ...
    <div class="content">
        <article>
            <section class="course">
                <h1><a href="__APP__/Course/index">我的收藏</a></h1>
                <div class="box">
                    <?php if(!empty($courses)): if(is_array($courses)): foreach($courses as $key=>$row): ?><figure>
