            ...
            <section class="contain">
                <aside>
                    <section class="classification">
                        <h2>分类导航</h2>
                        <div class="cla-con">
                            <?php if(is_array($clas)): foreach($clas as $key=>$row): ?><a href="__APP__/Course/classall/id/<?php echo ($row['id']); ?>"><?php echo ($row['name']); ?></a><?php endforeach; endif; ?>
                        </div>
                    ...
                    <section class="classification">
                        ...
                        <div class="brand">
                           <?php if(is_array($brands)): foreach($brands as $key=>$row): ?><figure>
                                <a href="__APP__/Course/brall/id/<?php echo ($row['id']); ?>">
                                    <img src="__PUBLIC__/Uploads/brand/<?php echo ($row['img']); ?>"/>
                                </a>
